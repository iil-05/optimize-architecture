...
const Register: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden py-6 sm:py-12 font-sans px-4">
            ...
            <div className="relative z-10 w-full max-w-md mx-auto">
                <div className="bg-white/80 backdrop-blur-lg border border-gray-200 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-elegant-lg animate-fade-in-up">
                    ...
                    <div className="text-center mb-6 sm:mb-8">
                        ...
                        <p className="text-sm sm:text-base text-gray-600">{t('auth.register.subtitle')}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                                ...
                                <div className="mt-1 sm:mt-2 space-y-1">
                                    {passwordRequirements.map((req, index) => (
                                        <div key={index} className="flex items-center text-xs">
                                            <Check
                                                className={`h-2.5 w-2.5 sm:h-3 sm:w-3 mr-1.5 sm:mr-2 ${req.met ? 'text-green-500' : 'text-gray-300'
                                                    }`}
                                            />
                        ...
                        <div className="flex items-start">
                            <input
                                ...
                                onChange={handleChange}
                                className="h-3 w-3 sm:h-4 sm:w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded transition-colors duration-300 mt-1"
                            />
                            <label htmlFor="acceptTerms" className="ml-2 sm:ml-3 block text-xs sm:text-sm text-gray-700">
                    ...
                    <div className="mt-4 sm:mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-3 sm:px-4 bg-white text-gray-500 text-xs sm:text-sm">{t('auth.register.orContinueWith')}</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-2 sm:gap-3">
                            <button className="group relative inline-flex w-full justify-center rounded-lg sm:rounded-xl border border-gray-300 bg-white/50 backdrop-blur-sm py-2.5 sm:py-3 px-3 sm:px-4 text-xs sm:text-sm font-medium text-gray-500 shadow-elegant hover:bg-gray-50 transition-all duration-300 hover:scale-105">
                                ...
                                <span className="ml-1 sm:ml-2 hidden sm:inline">{t('auth.register.google')}</span>
                            </button>
                            ...
                            <button className="group relative inline-flex w-full justify-center rounded-lg sm:rounded-xl border border-gray-300 bg-white/50 backdrop-blur-sm py-2.5 sm:py-3 px-3 sm:px-4 text-xs sm:text-sm font-medium text-gray-500 shadow-elegant hover:bg-gray-50 transition-all duration-300 hover:scale-105">
                                ...
                                <span className="ml-1 sm:ml-2 hidden sm:inline">{t('auth.register.facebook')}</span>
                            </button>
                        </div>
                    </div>
                </div>
